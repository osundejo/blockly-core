...
Blockly.BlockSvg.prototype.disposeUiEffect = function() {
  ...
  if(navigator.userAgent.indexOf("MSIE") >= 0 && !window.svgweb || navigator.userAgent.indexOf("Trident") >= 0) {
...
Blockly.FieldDropdown = function(menuGenerator, opt_changeHandler) {
  ...
  this.arrow_.appendChild(window.svgweb ? document.createTextNode("", true) : document.createTextNode(Blockly.RTL ? "\u25be " : " \u25be"));
...
Blockly.Tooltip.createDom = function() {
  ...
  if(window.svgweb) {
    Blockly.Tooltip.svgText_ = (Blockly.createSvgElement("rect", {"class":"blocklyTooltipText", "y":"11"}, svgGroup))
  }else {
...
window.svgweb ? "  font-family: arial;" : "  font-family: sans-serif;", window.svgweb ? "  font-size: 14pt;" : "  font-size: 11pt;", "  fill: #fff;", "}", ".blocklyNonEditableText>text {", "  pointer-events: none;", "}", ".blocklyNonEditableText>rect,", ".blocklyEditableText>rect {", "  fill: #fff;", "  fill-opacity: 0.6;", "}", ".blocklyNonEditableText>text,", ".blocklyEditableText>text {", "  fill: #000;", "}", ".blocklyEditableText:hover>rect {", "  stroke-width: 2;", "  stroke: #fff;", "}", "/*", 
...
".blocklyContextMenuShadow,", ".blocklyDropdownMenuShadow {", "  fill: #bbb;", window.svgweb ? "" : "  filter: url(#blocklyShadowFilter);", "}", ".blocklyTooltipText {", window.svgweb ? "  font-family: arial;" : "  font-family: sans-serif;", window.svgweb ? "  font-size: 12pt;" : "  font-size: 9pt;", "  fill: #000;", "}", "", ".blocklyIconShield {", "  cursor: default;", "  fill: #00c;", "  stroke-width: 1px;", "  stroke: #ccc;", "}", ".blocklyIconGroup:hover>.blocklyIconShield {", "  fill: #00f;", 
"  stroke: #fff;", "}", ".blocklyIconGroup:hover>.blocklyIconMark {", "  fill: #fff;", "}", ".blocklyIconMark {", "  cursor: default !important;", window.svgweb ? "  font-family: arial;" : "  font-family: sans-serif;", window.svgweb ? "  font-size: 12pt;" : "  font-size: 9pt;", "  font-weight: bold;", "  fill: #ccc;", "  text-anchor: middle;", "}", ".blocklyWarningBody {", "}", ".blocklyMinimalBody {", "  margin: 0;", "  padding: 0;", "}", ".blocklyCommentTextarea {", "  margin: 0;", "  padding: 2px;", 
"  border: 0;", "  resize: none;", "  background-color: #ffc;", "}", ".blocklyHtmlInput {", window.svgweb ? "  font-family: arial;" : "  font-family: sans-serif;", window.svgweb ? "  font-size: 14pt;" : "  font-size: 11pt;", "  border: none;", "  outline: none;", "  width: 100%", "}", ".blocklyContextMenuBackground,", ".blocklyMutatorBackground {", "  fill: #fff;", "  stroke-width: 1;", "  stroke: #ddd;", "}", ".blocklyContextMenuOptions>.blocklyMenuDiv,", ".blocklyContextMenuOptions>.blocklyMenuDivDisabled,", 
".blocklyDropdownMenuOptions>.blocklyMenuDiv {", "  fill: #fff;", "}", ".blocklyContextMenuOptions>.blocklyMenuDiv:hover>rect,", ".blocklyDropdownMenuOptions>.blocklyMenuDiv:hover>rect {", "  fill: #57e;", "}", ".blocklyMenuSelected>rect {", "  fill: #57e;", "}", ".blocklyMenuText {", "  cursor: default !important;", window.svgweb ? "  font-family: arial;" : "  font-family: sans-serif;", "  font-size: 15px; /* All context menu sizes are based on pixels. */", "  fill: #000;", "}", ".blocklyContextMenuOptions>.blocklyMenuDiv:hover>.blocklyMenuText,", 
...
Blockly.init_ = function() {
  ...
  if(Blockly.languageTree) {
    if(Blockly.hasCategories) {
      ...
      translation = "translate(" + Blockly.mainWorkspace.scrollX + ", 0)";
...
Blockly.FieldAngle = function(text, opt_changeHandler) {
  ...
  this.symbol_.appendChild(window.svgweb ? document.createTextNode("\u00b0", true) : document.createTextNode("\u00b0"));
